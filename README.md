...
1-59/2 * * *    cd /root/apollo && python3 open.py  --key binance_api_key --secret binance_api_secret
0-58/2 * * *    cd /root/apollo && python3 close.py --key binance_api_key --secret binance_api_secret
~~~
